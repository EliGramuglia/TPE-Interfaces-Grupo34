...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const tarjetas = {
        accion: [
            new Tarjeta("shadow ninja revenge", "shadow-ninja-revenge.jpg", 0, 4.7),
            new Tarjeta("cursed treasure 2", "cursed-treasure-2.jpg", 0, 3.8),
            new Tarjeta("endless waves survival", "endless-waves-survival.jpg", 1299, 4.0),
            new Tarjeta("endless siege", "endless-siege.jpg", 0, 3.2),
            new Tarjeta("ninja hands", "ninja-hands.jpg", 1400, 4.9),
        ...
        aventura: [
            new Tarjeta("daily room escape", "daily-room-escape.jpg", 0, 4.2),
            new Tarjeta("senya and oscar 2", "senya-and-oscar-2.jpg", 1250, 3.0),
            new Tarjeta("onebit adventure", "onebit-adventure.jpg", 399, 3.7),
            new Tarjeta("dead land survival", "dead-land-survival.jpg", 0, 4.5),
            new Tarjeta("battle arena", "battle-arena.jpg", 0, 4.7),
        ...
        clasicos: [
            new Tarjeta("pac-man", "pac-man.jpg", 450, 4.8),
            new Tarjeta("bubble pop", "bubble-pop.jpg", 799, 4.3),
            new Tarjeta("domino battle", "domino-battle.jpg", 1299, 3.2),
            new Tarjeta("space alien invaders", "space-alien-invaders.jpg", 0, 4.9),
            new Tarjeta("piles of mahjong", "piles-of-mahjong.jpg", 0, 3.9),
        ...
        futbol: [
            new Tarjeta("CGFC-24", "CGFC-24.jpg", 1599, 4.5),
            new Tarjeta("pongoal", "pongoal.jpg", 0, 4.1),
            new Tarjeta("penalty shooters", "penalty-shooters.jpg", 0, 4.3),
            new Tarjeta("soccer random", "soccer-random.jpg", 630, 4.2),
            new Tarjeta("foosball 3d", "foosball-3d.jpg", 0, 4.6),
